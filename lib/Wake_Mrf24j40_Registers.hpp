#ifndef _WAKE_MRF24J40_REGISTERS
#define _WAKE_MRF24J40_REGISTERS


/*Short address register address defs*/
...
/*Long address register address defs*/

#define MRF_TXFIFO    	0x000
